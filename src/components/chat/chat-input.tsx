...
import { Send, Save, Mic, MicOff } from "lucide-react";
import {
  type FC,
  type KeyboardEvent,
  useRef,
  ...
  return (
    <div className="relative mx-4 mb-8 sm:mx-0">
      ...
      <form onSubmit={handleSubmit} className="relative flex items-center ">
        <div className="relative w-full">
          <TextareaAutosize
            ...
            className={cn(
              "resize-none block w-full rounded-md border border-input bg-background py-3 px-4 pr-24",
              ...
              isListening && "ring-2 ring-primary border-primary"
            )}
            value={input}
      ...
      <div className="mt-2 flex justify-between text-xs text-muted-foreground">
        <span>
          Press{" "}
          <kbd className="rounded-md border px-1 py-0.5 text-xs font-semibold">
            Enter
          </kbd>{" "}
          to send
        </span>
